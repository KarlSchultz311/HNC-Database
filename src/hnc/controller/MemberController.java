...
public class MemberController implements ActionListener {
    ...
    private void confirmDeleteFamilyActionPerformed(ActionEvent event, MemberUI memberUI) {
        ...
        tab,it will then delete the family row from the family database. The database
        is set so the foreign key family ID values of the members will be set to null when
        the familyID is deleted from the families table*/
    ...
    private void familySearchActionPerformed(ActionEvent event, MemberUI memberUI){
        ...
        fields, and search the database for matching family rows. The results will
        be displayed in the text area of the tab.
        */
        FamilyManager famMan = new FamilyManager();
